...
| 05 | [技术路线图](05-技术路线图-CN.md) | [Technological Roadmap](05-Technological-Roadmap-EN.md) | ⭐ **v2.1 精简版 + Mermaid 流程图**：一页速览、主技术流程图、**六步流程详解（①定标准→②备料→③造料→④学习→⑤判断→⑥交付）**、三视野 H1–H3、TG1–TG5 决策门与 D1–D8 降级路径图、甘特时间线、关键路径与人力分配 |
...
→ 05 §2（流程详解） → 05 §4（TG1–TG5 决策门与 D1–D8 降级路径）
07 (charter) → 06 §3 (leader role and election) → 06 §4 (RACI)
→ 05 §2 (step walkthrough) → 05 §4 (decision gates and downgrade paths)
```
